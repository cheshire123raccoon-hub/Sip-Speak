    ...
    document.getElementById('mainContent').innerHTML = `
        ...
        <div class="question-box mt-20" style="border-left: none;">
            <ul style="padding-left: 20px; line-height: 2.2;">
                ...
                <li>Has this lesson inspired you to travel somewhere new?</li>
                <li>What does "travel broadens the mind" mean to you now?</li>
                <li>Rate today's lesson using travel vocabulary! (e.g., "It was a hidden gem!")</li>
            </ul>
        </div>
