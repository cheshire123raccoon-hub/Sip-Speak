    ...
    document.getElementById('mainContent').innerHTML = `
        ...
        <div class="question-box mt-20" style="border-left: none;">
            <ul style="padding-left: 20px; line-height: 2.2;">
                ...
                <li>Which vocabulary category was most useful for you?</li>
                <li>Did you discover any new movies to watch?</li>
                <li>What's one film you want to rewatch with fresh eyes?</li>
                <li>Rate today's lesson: Would you recommend it? (Use today's vocab!)</li>
            </ul>
        </div>
        <div class="text-center mt-20">
            <h3 style="color: var(--primary); font-family: 'Comfortaa', cursive;">That's a wrap! 🎬✨</h3>
            <p style="margin-top: 10px;">See you at the next Sip & Speak!</p>
        </div>
    `;
}
